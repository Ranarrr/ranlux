...
void interfacefactory::setup() {
	...
	globals::engineserver = engine.grabinterface<IVEngineServer*>( "VEngineServer" );
	// just get the interface, idk actually
	// yeah gets all of the interfaces :D
	...
	globals::enginetrace = engine.grabinterface<IEngineTrace*>( "EngineTraceClient" );
